...
<div class="container mx-auto">
  <div class="mt-4 flex h-24">
    <a href="<?= $_POST['ebayurl'] ?>" title="Shop Home" target="_blank" class="flex-0">
      <img src="<?= $_POST['logourl'] ?>" class="h-24 ml-8 mb-2" />
    </a>
  ...
  <img src="<?= $_POST['herourl'] ?>" class="w-full bg-gray-100 mt-3" />

  <? if(isset($_POST['category'])){ ?>
  <div class="bg-primary rounded-xl mt-5 mb-5 px-5 py-4 my-5 text-sm ml-8 mr-8">
  ...
  <div class="flex border-t-2 mt-3 pt-8"  id="templateBody">
    <div class="flex-auto ml-8 mr-8">
      <div class="">
  ...
  <div class="text-center text-sm mt-5 mb-5 "><img src="https://www.shopiago.com/application/themes/shopiago/assets/images/logo.png" class="h-8 m-auto mb-2" />This listing is created with Shopiago.</div>
</div>
